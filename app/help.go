...
func (h helpTypeGeneral) toContent() string {
	content := lipgloss.JoinVertical(lipgloss.Left,
		...
		keyStyle.Render("D")+descStyle.Render("         - Kill (archive) the selected session"),
		keyStyle.Render("U")+descStyle.Render("         - Restore an archived session"),
		...
		keyStyle.Render("(in insert)")+descStyle.Render(" - Keystrokes go to the agent's pane (pure injection: backspace, arrows, history, Ctrl-C all work); fleet bindings are suspended"),
